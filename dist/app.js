...
var Separator = /* @__PURE__ */ forwardRef(
  /* @__PURE__ */ __name4(function Separator2(props, forwardedRef) {
...
function composeEventHandlers(originalEventHandler, ourEventHandler, { checkForDefaultPrevented = true } = {}) {
  return /* @__PURE__ */ __name5(function handleEvent(event) {
...
function createContext2(rootComponentName, defaultContext) {
  ...
  const Provider = /* @__PURE__ */ __name6((props) => {
  ...
  __name6(useContext2, "useContext");
...
function createContextScope(scopeName, createContextScopeDeps = []) {
  ...
  __name6(createContext3, "createContext");
  const createScope = /* @__PURE__ */ __name6(() => {
    const scopeContexts = defaultContexts.map((defaultContext) => {
      return createContext(defaultContext);
    });
    return /* @__PURE__ */ __name6(function useScope(scope) {
...
function composeContextScopes(...scopes) {
  ...
  const createScope = /* @__PURE__ */ __name6(() => {
    ...
    return /* @__PURE__ */ __name6(function useComposedScopes(overrideScopes) {
...
function createCollection(name) {
  ...
  const CollectionProvider = /* @__PURE__ */ __name7((props) => {
  ...
  __name7(useCollection2, "useCollection");
  return [
...
function createCollection2(name) {
  ...
  const [CollectionContextProvider, useCollectionContext] = createCollectionContext(
    PROVIDER_NAME,
    {
      ...
      setItemMap: /* @__PURE__ */ __name7(() => void 0, "setItemMap")
    }
  );
  const CollectionProvider = /* @__PURE__ */ __name7(({ state, ...props }) => {
    return state ? /* @__PURE__ */ jsx(CollectionProviderImpl, { ...props, state }) : /* @__PURE__ */ jsx(CollectionInit, { ...props });
  }, "CollectionProvider");
  CollectionProvider.displayName = PROVIDER_NAME;
  const CollectionInit = /* @__PURE__ */ __name7((props) => {
    const state = useInitCollection();
    return /* @__PURE__ */ jsx(CollectionProviderImpl, { ...props, state });
  }, "CollectionInit");
  CollectionInit.displayName = PROVIDER_NAME + "Init";
  const CollectionProviderImpl = /* @__PURE__ */ __name7((props) => {
  ...
  __name7(useInitCollection, "useInitCollection");
  function useCollection2(scope) {
...
var RovingFocusGroup = /* @__PURE__ */ forwardRef(
  ...
  /* @__PURE__ */ __name14(function RovingFocusGroup2(props, forwardedRef) {
    return /* @__PURE__ */ jsx(Collection.Provider, { scope: props.__scopeRovingFocusGroup, children: /* @__PURE__ */ jsx(Collection.Slot, { scope: props.__scopeRovingFocusGroup, children: /* @__PURE__ */ jsx(RovingFocusGroupImpl, { ...props, ref: forwardedRef }) }) });
  }, "RovingFocusGroup")
);
var RovingFocusGroupImpl = /* @__PURE__ */ forwardRef(/* @__PURE__ */ __name14(function RovingFocusGroupImpl2(props, forwardedRef) {
  const {
...
var RovingFocusGroupItem = /* @__PURE__ */ forwardRef(
  // blank line to reduce diff noise
  /* @__PURE__ */ __name14(function RovingFocusGroupItem2(props, forwardedRef) {
    const {
      __scopeRovingFocusGroup,
      focusable = true,
      active = false,
...
__name14(getDirectionAwareKey, "getDirectionAwareKey");
...
__name14(getFocusIntent, "getFocusIntent");
...
var Tabs = /* @__PURE__ */ forwardRef(
  // blank line to reduce diff noise
  /* @__PURE__ */ __name16(function Tabs2(props, forwardedRef) {
    const {
      __scopeTabs,
      value: valueProp,
      onValueChange,
...
var TabsList = /* @__PURE__ */ forwardRef(
  // blank line to reduce diff noise
  /* @__PURE__ */ __name16(function TabsList2(props, forwardedRef) {
...
var TabsTrigger = /* @__PURE__ */ forwardRef(
  /* @__PURE__ */ __name16(function TabsTrigger2(props, forwardedRef) {
...
var TabsContent = /* @__PURE__ */ forwardRef(
  /* @__PURE__ */ __name16(function TabsContent2(props, forwardedRef) {
...
__name16(makeTriggerId, "makeTriggerId");
function makeContentId(baseId, value) {
  return `${baseId}-content-${value}`;
}
__name16(makeContentId, "makeContentId");
var Root22 = Tabs;
var List = TabsList;
...
var RAMP_STEPS = ["l1", "l2", "l3", "l4", "l5"];
function pick(variant, prefix) {
  return Object.entries(AYU_PALETTES[variant]).filter(([key]) => key.startsWith(`${prefix}.`)).map(([key, hex]) => ({ name: key.slice(prefix.length + 1), hex }));
}
function isLightColor(hex) {
  const r2 = parseInt(hex.slice(1, 3), 16);
  const g = parseInt(hex.slice(3, 5), 16);
  const b = parseInt(hex.slice(5, 7), 16);
  return 0.299 * r2 + 0.587 * g + 0.114 * b > 145;
}
...
function useActiveTheme() {
  ...
  useEffect(() => {
    let cancelled = false;
    void rpc.call("activeTheme").then((result) => {
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-1.5 p-2", children: lines.map((segments, row) => /* @__PURE__ */ jsx("div", { className: "flex gap-1", children: segments.map((segment, index) => /* @__PURE__ */ jsx(
          "span",
          {
...
function ThemeRow({
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx(ThemePreview, { theme }),
        /* @__PURE__ */ jsxs("div", { className: "min-w-32 flex-1", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx("span", { className: "text-sm font-medium text-foreground", children: theme.name }),
            active && /* @__PURE__ */ jsx(Badge, { variant: "secondary", children: "Active" })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "mt-0.5 text-xs text-muted-foreground", children: theme.note })
        ] }),
        !active && /* @__PURE__ */ jsx(
          Button,
          {
...
function RampRow({ hue, variant }) {
  const palette = AYU_PALETTES[variant];
  return /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
    /* @__PURE__ */ jsx("span", { className: "w-14 shrink-0 text-xs text-muted-foreground", children: hue }),
    /* @__PURE__ */ jsx("div", { className: "flex h-9 flex-1 overflow-hidden rounded-md", children: RAMP_STEPS.map((step) => {
...
function SwatchGrid({ swatches }) {
  return /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 gap-x-4 gap-y-1 sm:grid-cols-3", children: swatches.map((swatch) => /* @__PURE__ */ jsxs(
    "button",
    {
      type: "button",
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("span", { className: "min-w-0 flex-1 truncate text-xs text-foreground", children: swatch.name }),
        /* @__PURE__ */ jsx("span", { className: "font-mono text-[10px] text-muted-foreground", children: swatch.hex })
      ]
    },
    swatch.name
  )) });
...
function Section({
  ...
  return /* @__PURE__ */ jsxs("section", { className: "flex flex-col gap-3", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-baseline gap-2", children: [
      /* @__PURE__ */ jsx("h2", { className: "text-sm font-medium text-foreground", children: title }),
      hint && /* @__PURE__ */ jsx("span", { className: "text-xs text-subtle-foreground", children: hint })
    ] }),
    children
  ] });
}
function AyuPanel() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex w-full max-w-3xl flex-col gap-8", children: [
    /* @__PURE__ */ jsxs(
      Section,
      {
        title: "Theme",
        ...
        children: [
          /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-2", children: loaded ? AYU_THEMES.map((theme) => /* @__PURE__ */ jsx(
            ThemeRow,
            {
              theme,
            ...
            theme.id
          )) : AYU_THEMES.map((theme) => /* @__PURE__ */ jsx(Skeleton, { className: "h-[88px] rounded-lg" }, theme.id)) }),
          loaded && !activeMeta && /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "Another theme is active right now \u2014 applying one of these switches the whole app to ayu." })
        ]
      }
    ),
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center justify-between gap-3", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h2", { className: "text-sm font-medium text-foreground", children: "Palette" }),
          /* @__PURE__ */ jsx("p", { className: "mt-0.5 text-xs text-muted-foreground", children: "Every colour ayu publishes for this variant. Click any swatch to copy its hex." })
        ] }),
        /* @__PURE__ */ jsx(
          Tabs3,
          {
            ...
            children: /* @__PURE__ */ jsxs(TabsList3, { children: [
              /* @__PURE__ */ jsx(TabsTrigger3, { value: "light", children: "Light" }),
              /* @__PURE__ */ jsx(TabsTrigger3, { value: "dark", children: "Dark" }),
              /* @__PURE__ */ jsx(TabsTrigger3, { value: "mirage", children: "Mirage" })
            ] })
          }
        )
      ] }),
      /* @__PURE__ */ jsx(Section, { title: "Ramps", hint: "l1 \u2192 l5, darker to lighter", children: /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-1.5", children: RAMP_ORDER.map((hue) => /* @__PURE__ */ jsx(RampRow, { hue, variant }, hue)) }) }),
      /* @__PURE__ */ jsx(Section, { title: "Syntax", children: /* @__PURE__ */ jsx(SwatchGrid, { swatches: syntax }) }),
      /* @__PURE__ */ jsx(Section, { title: "Terminal", children: /* @__PURE__ */ jsx(SwatchGrid, { swatches: terminal }) }),
      /* @__PURE__ */ jsx(Section, { title: "Interface", hint: "editor, chrome, and vcs", children: /* @__PURE__ */ jsx(SwatchGrid, { swatches: [...vcs, ...interfaceSwatches] }) })
    ] })
  ] });
}
var app_default = definePluginApp((app) => {
  app.slots.settingsSection({
    ...
    description: "Switch between the three ayu themes and copy any colour the palette publishes.",
    component: AyuPanel
  });
});
export {
